...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Spring%20Boot-2.6.3-green" alt="SpringBoot"/>
...
---|---|---
Spring Boot | 2.3.*.RELEASE | <img src="https://img.shields.io/badge/Spring%20Boot-2.6.3-blue" alt="SpringBoot"/>
...
## 🔧 功能特点
- 主体框架：采用最新的`Spring Cloud 2021.0.0`, `Spring Boot 2.6.3`, `Spring Cloud Alibaba 2021.1`版本进行系统设计；
