...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Spring%20Boot-2.5.6-green" alt="SpringBoot"/>
...
---|---|---
Spring Boot | 2.3.*.RELEASE | <img src="https://img.shields.io/badge/Spring%20Boot-2.5.6-blue" alt="SpringBoot"/>
...
## 🔧 功能特点
- 主体框架：采用最新的`Spring Cloud 2020.0.4`, `Spring Boot 2.5.6`, `Spring Cloud Alibaba 2021.1`版本进行系统设计；
