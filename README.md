...
## 🔧 功能特点
- 主体框架：采用最新的`Spring Cloud 2020.0.3`, `Spring Boot 2.5.5`, `Spring Cloud Alibaba 2021.1`版本进行系统设计；
...
## 🔥 前端重大更新
前端采用`Vue 3.2.9`、`Vite 2.5.3`、 `Ant-Design-Vue 2.2.6`、`TypeScript` 的大型中后台解决方案。
### 👉 技术栈
- Vue 3.2.9
- Pinia 2.0.0-rc.7
- vue-i18n 9.1.7
